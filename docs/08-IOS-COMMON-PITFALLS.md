...
### Pitfall 43: A scoping field the tool does not recognise fails SILENTLY — and two tools fail in opposite directions
...
### Pitfall 44: Glob metacharacters in directory names — the scoped rule that matches nothing
