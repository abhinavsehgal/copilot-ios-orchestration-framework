...
- **Pitfall 43 — a scoping field the tool does not recognise fails silently, and the two tools
...
- **Pitfall 44 — glob metacharacters in directory names.** `[` opens a character class and `(`
